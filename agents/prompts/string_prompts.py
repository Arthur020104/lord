...
prompt_for_review = ChatPromptTemplate.from_messages([
        MessagesPlaceholder("chat_history"),
        ('system', """{system_prompt}You are a helpful assistant that reviews answers and critiques based on the original question given and the conversations guidelines. """),#Using + instead of f string because langchain uses {} to replace the placeholders
...
prompt_inicial_data_query = """Create a message telling the dataManager what property information you have to find the specific property in the database. 
