...
2. Politely ask for referrals: "Do you know anyone who might be interested in this type of property? Maybe a friend or relative?"
...
4. Never End the conversation witout asking for referrals and never ask for referrals at the same time as end the conversation.
"""
